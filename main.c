...
float mouseX, mouseY;
typedef enum {INTRO, MENU, INSTRUCTIONS, GAME, GAMEOVER} view;
...
// Arrays for alien and spaceship components
...
void displayRasterText(float x, float y, float z, char *string);
void init(void);
void introScreen(void);
void startScreenDisplay(void);
void backButton(void);
void instructionsScreenDisplay(void);
void DrawAlienBody(bool isPlayer1);
void DrawAlienCollar(void);
void DrawAlienFace(bool isPlayer1);
void DrawAlienBeak(void);
